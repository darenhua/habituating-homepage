...
describe("habitService", () => {
    ...
    describe("getWeekHabits", () => {
        ...
        it("should handle empty results", async () => {
            ...
            // Restore test data
            await supabase.from("habit_tracking").insert(testData);
        });
        ...
        it("should validate date range calculation", async () => {
            ...
            habits.forEach((habit) => {
                ...
                expect(habitDate.getTime()).toBeLessThanOrEqual(
                    testDate.getTime(),
                );
            });
        });
    ...
    describe("getYearHabits", () => {
        ...
        beforeEach(async () => {
            ...
            await supabase.from("habit_tracking").insert(yearTestData);
        });
